...
public class UnitManager : MonoBehaviour {
	...
	{
		if (Pos[0] != null)
			BuildingManager.LoadBuildingByType (UnitType.BUILDING_BASE, Pos[0].transform);
		if (Pos[1] != null)
			BuildingManager.LoadBuildingByType (UnitType.BUILDING_TOWN_HALL, Pos[1].transform);
